  ...
  return (
    <footer className="bg-gray-800 ">
      <div className="max-w-screen-xl px-4 pt-8 pb-8 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="max-w-xs mt-4 text-sm text-gray-300">
              Tradutor de Português para Criolo Foro e Criolo Foro para
              Português
            </p>
          </div>
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <p className="font-medium text-gray-500">Tradutor</p>
            ...
            <div>
              <div className="flex mt-8 space-x-6 text-gray-600">
                ...
                <a
                  ...
                  rel="noreferrer"
                >
                  <span className="sr-only cursor-pointer"> Instagram </span>
                  <svg
                    className="w-6 h-6 cursor-pointer"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                ...
                <a
                  ...
                  rel="noreferrer"
                >
                  <span className="sr-only cursor-pointer"> Twitter </span>
                  <svg
        ...
        <p className="mt-8 text-xs text-slate-300">© 2022 Watson dos Santos</p>
      </div>
    </footer>
  );
}
