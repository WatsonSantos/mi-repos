export function Square() {
  return (
    <>
      ...
      <div className="fixed -z-10 w-10 h-5 bg-black opacity-20 right-96 top-28"></div>
      ...
      <div className="fixed -z-10 w-28 h-28 bg-custom_yellow bottom-32 right-[600px] opacity-10"></div>
